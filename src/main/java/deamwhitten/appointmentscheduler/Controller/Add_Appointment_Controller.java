...
public class Add_Appointment_Controller implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle resourceBundle) {
        try {
            int autoGeneratedAppointmentID = Appointments_Collections.getAllAppointments().size() + 1;
    ...
    private void collectInputsAndSendToDA() {
        int id = Integer.parseInt(appID_input.getText());
        ...
        String start =
                date_selection.getValue() + " " + start_selection.getSelectionModel().getSelectedItem();
        String end =
                date_selection.getValue() + " " + start_selection.getSelectionModel().getSelectedItem();
        Appointments_DA.writeNewAppointmentDataToDB(id, customerName, contact,
